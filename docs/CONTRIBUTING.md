...
Please read the project documentation and check existing issues and pull requests before starting significant work.
...
- Update relevant documentation when behaviour or usage changes
...
A pull request or issue does not imply that TaskTide will adopt the proposed behaviour, design, dependency, feature, or compatibility requirement.

The maintainers may decline, defer, modify, or close contributions that do not fit the project's scope, design goals, quality standards, or priorities.
